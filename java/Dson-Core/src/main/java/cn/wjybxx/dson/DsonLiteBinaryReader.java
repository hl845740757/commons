 ...
 * date - 2023/4/22
 */
public final class DsonLiteBinaryReader extends AbstractDsonLiteReader {
    ...
    public DsonLiteBinaryReader(DsonReaderSettings settings, DsonInput input, boolean autoClose) {
        super(settings);
    ...
    protected FixedPoint4 doReadFx4() {
        return FixedPoint4.fromRaw(currentWireType.readInt64(input));
    }
    ...
    protected FixedVector4 doReadFv4() {
        return DsonReaderUtils.readFv4(input, currentWireTypeBits);
    }
    // endregion
