...
public interface DsonWriter extends AutoCloseable {
    ...
    void writeFx4(String name, FixedPoint4 value);
    ...
    void writeFv4(String name, FixedVector4 fv4, FixedVector4Style style);
    ...
    void writeFv4(FixedVector4 fv4, FixedVector4Style style);
    ...
    default void writeFv4(String name, FixedVector4 fv4) {
        writeFv4(name, fv4, FixedVector4Style.ARRAY);
    }
    ...
    default void writeFv4(FixedVector4 fv4) {
        writeFv4(fv4, FixedVector4Style.ARRAY);
    }
    // endregion
}