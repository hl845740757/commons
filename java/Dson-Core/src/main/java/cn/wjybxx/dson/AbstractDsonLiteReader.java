...
public abstract class AbstractDsonLiteReader implements DsonLiteReader {
    ...
    protected AbstractDsonLiteReader(DsonReaderSettings settings) {
    ...
    /** 前进到读值状态 */
    protected final void advanceToValueState(int name, @Nullable DsonType requiredType) {
    ...
    @Override
    public boolean readBool(int name) {
    ...
    public FixedPoint4 readFx4(int name) {
    ...
    @Override
    public ExtDateTime readDateTime(int name) {
    ...
    @Override
    public Timestamp readTimestamp(int name) {
    ...
    @Override
    public FixedVector4 readFv4(int name) {
