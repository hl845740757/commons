...
public class ForwardUniFuture<T> implements UniFuture<T> {
    ...
    @Override
    public <X extends Throwable> UniCompletionStage<T> composeCatching(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends UniCompletionStage<T>> fallback, @Nullable IContext ctx, int options) {
        return future.composeCatching(exceptionType, fallback, ctx, options);
    }

    @Override
    public <X extends Throwable> UniCompletionStage<T> composeCatching(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends UniCompletionStage<T>> fallback) {
        return future.composeCatching(exceptionType, fallback);
    }

    @Override
    public <X extends Throwable> UniCompletionStage<T> composeCatchingAsync(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends UniCompletionStage<T>> fallback) {
        return future.composeCatchingAsync(exceptionType, fallback);
    }

    @Override
    public <X extends Throwable> UniCompletionStage<T> composeCatchingAsync(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends UniCompletionStage<T>> fallback, @Nullable IContext ctx, int options) {
        return future.composeCatchingAsync(exceptionType, fallback, ctx, options);
    }

    @Override
    public <U> UniCompletionStage<U> composeHandle(TriFunction<? super IContext, ? super T, ? super Throwable, ? extends UniCompletionStage<U>> fn, @Nullable IContext ctx, int options) {
    ...
    @Override
    public <U> UniCompletionStage<U> composeHandleAsync(TriFunction<? super IContext, ? super T, ? super Throwable, ? extends UniCompletionStage<U>> fn, @Nullable IContext ctx, int options) {
    ...
    @Override
    public <X extends Throwable> UniCompletionStage<T> catching(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends T> fallback, @Nullable IContext ctx, int options) {
        return future.catching(exceptionType, fallback, ctx, options);
    }

    @Override
    public <X extends Throwable> UniCompletionStage<T> catching(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends T> fallback) {
        return future.catching(exceptionType, fallback);
    }

    @Override
    public <X extends Throwable> UniCompletionStage<T> catchingAsync(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends T> fallback) {
        return future.catchingAsync(exceptionType, fallback);
    }

    @Override
    public <X extends Throwable> UniCompletionStage<T> catchingAsync(Class<X> exceptionType, BiFunction<? super IContext, ? super X, ? extends T> fallback, @Nullable IContext ctx, int options) {
