...
public class UniPromiseTask<V> implements UniFutureTask<V> {
    ...
    public static <V> UniPromiseTask<V> ofCallable(Callable<V> action, UniPromise<V> promise) {
        return new UniPromiseTask<>(action, promise, TaskBuilder.TYPE_CALLABLE);
    }

    public static <TC, V> UniPromiseTask<V> ofFunction(Function<? super TC, V> action, UniPromise<V> promise) {
