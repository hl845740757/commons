...
public class DsonDouble4 : DsonValue
{
    ...
    public override DsonType DsonType => DsonType.Double4;
    public Double4 Value => _value;

    #region equals

    public bool Equals(DsonDouble4? other) {
    ...
    public static bool operator ==(DsonDouble4? left, DsonDouble4? right) {
