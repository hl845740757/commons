...
{
public class MultiConsumerBarrier : ConsumerBarrier
{
    ...
    private readonly Sequence[] memberSequences;
    ...
    /// <param name="memberCount">消费者线程数量</param>
    ...
    public void Claim(long sequence) {
        ...
        foreach (Sequence memberSequence in memberSequences) {
    ...
    public long Sequence() {
        return Util.GetMinimumSequence(memberSequences, _groupSequence.GetVolatile());
    }
    ...
    public long MinimumSequence() {
        return Util.GetMinimumSequence(dependentBarriers, memberSequences,_groupSequence.GetVolatile());
    }
