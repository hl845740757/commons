...
public class ArrayTypeName : TypeName
{
    ...
    public static ArrayTypeName Get(TypeName elementType, TypeNameAttributes attributes = TypeNameAttributes.None) {
        return new ArrayTypeName(elementType, attributes);
    }

    public static ArrayTypeName Get(Type elementType, TypeNameAttributes attributes = TypeNameAttributes.None) {
