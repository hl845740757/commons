...
public sealed class ServiceParallel1Codec<T> : AbstractDsonCodec<ServiceParallel<T>> where T : class
{
    ...
    protected override void WriteFields(IDsonObjectWriter writer, in ServiceParallel<T> inst) {
