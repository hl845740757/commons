...
public static class Dsons
{
    ...
    public static void WriteDsonValue<TName>(IDsonWriter<TName> writer, DsonValue dsonValue, TName? name) where TName : IEquatable<TName> {
        ...
        switch (dsonValue.DsonType) {
            ...
            case DsonType.FixedPoint4: {
                writer.WriteFx4(dsonValue.AsFx4());
                break;
            }
            ...
            case DsonType.FixedVector4: {
                writer.WriteFv4(dsonValue.AsFv4());
                break;
            }
    ...
    public static DsonValue ReadDsonValue<TName>(IDsonReader<TName> reader) where TName : IEquatable<TName> {
        ...
        switch (dsonType) {
            ...
            case DsonType.FixedPoint4: return new DsonFx4(reader.ReadFx4());
            ...
            case DsonType.FixedVector4: return new DsonFv4(reader.ReadFv4());
            case DsonType.Header: {
    ...
    public static DsonScanner NewLinesScanner(IList<LineInfo> lineInfos) {
