...
/// </summary>
public struct Integer4 : IEquatable<Integer4>
{
    public int v0;
    public int v1;
    public int v2;
    ...
    public Integer4(int v0, int v1, int v2, int v3 = 0) {
        this.v0 = v0;
        this.v1 = v1;
        this.v2 = v2;
        this.v3 = v3;
    ...
    public override bool Equals(object? obj) {
        return obj is Integer4 other && Equals(other);
    }
    ...
    public static bool operator ==(Integer4 left, Integer4 right) {
